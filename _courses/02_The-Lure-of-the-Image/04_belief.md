...
Read: Stan Portus, [*Responding to cherrypicker*]({{ site.baseurl }}/courses/02_The-Lure-of-the-Image/assets/texts/04_Portus_RespondingToCherrypicker.pdf), 2025
 
Make: Choose a found image — a screenshot, a meme, a low-res photograph, or a frame from a film — that has circulated online in a way that distorted or detached it from its original meaning. Using any image-editing tools at your disposal (including but not limited to generative AI), annotate, modify, or reframe the image: add red circles, arrows, text overlays, zoomed crops, or other markers typical of conspiracy content, debunking culture, or viral image analysis. The result should be a single composite image or a short sequence (3–5 images) that reflects on how the visual rhetoric of "evidence" — the graphic language used to guide a viewer's belief — shapes what we think we are seeing.
