...
Sheffer uses this juxtaposition to show how users with large numbers of followers define how a ‘successful’ image should look like: the more likes, clicks and shares a picture gets, the more influence it has on visual idioms. This pictorial language is imitated by other users around the world and thus becomes an unwritten aesthetic rule, which ends up in a process of standardisation. In playing the ‘attention’ game, it is not originality that counts so much as how well it can be staked out and marketed."</blockquote>
#### – Marco De Mutiis, Matteo Bittanti, <a href="https://www.howtowinat.photography/en/post/insta_repeat"><em>How to Win at Photography – Image-making as Play</em></a>, Fotomuseum Winterthur, online 2021.
